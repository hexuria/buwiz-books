...
import { getClosedThrough } from "@/lib/period-close";
import { isDateLocked } from "@/lib/period-lock-policy";
import {
  buildJournalMergePairKey,
  evaluateJournalMergePreflight,
  type JournalMergeFact,
  type JournalMergeFacts,
  type JournalMergePreview,
  type JournalOperationalOriginFact,
} from "@/lib/journal-merge-policy";

export {
  buildJournalMergePairKey,
  classifyJournalDirection,
  evaluateJournalMergePreflight,
} from "@/lib/journal-merge-policy";
export type {
  JournalMergeCheck,
