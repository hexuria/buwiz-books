/**
 * Government list page — thin wrapper over the shared EntityListPage.
...
export const Route = createFileRoute("/entities/government")({
...
function GovernmentPage() {
  ...
  return (
    <EntityListPage
      config={ENTITY_CONFIGS.government}
      search={search}
