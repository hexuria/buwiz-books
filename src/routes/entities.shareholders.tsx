/**
 * Shareholders list page — thin wrapper over the shared EntityListPage.
...
export const Route = createFileRoute("/entities/shareholders")({
...
function ShareholdersPage() {
  ...
  return (
    <EntityListPage
      config={ENTITY_CONFIGS.shareholder}
      search={search}
