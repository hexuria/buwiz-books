...
export const organizationAccountingSettings = pgTable(
  "organization_accounting_settings",
  {
    ...
    // ISO 3166-1 alpha-2. Nullable on purpose: null = "not set".
    // Country = "PH" no longer enables BIR filing in Books (that product
    // lives in Buwiz Forms). Derived active/archived/off still exists so
    // stored PH rows can be exported later; switching away NEVER deletes them.
